...
return (
  <div className="container">
    ...
    <button onClick={amount > 1 ? () => setAmout((p) => p - 1) : () => setAmout(1)}>
                    -
                </button>
            <p>{amount}</p>
    <button onClick={() => setAmout((p) => p + 1)}>+</button>
              ...
              <div className="info__cart">
                <button className="info__btn1">Приобрести в Рассрочку</button>
                <button className="info__btn2">Добавить корзина</button>
                <button className="info__btn3">Купить в 1 клик</button>
              </div>
